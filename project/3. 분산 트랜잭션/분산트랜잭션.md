...
1) Growing Phase (확장단계) : Lock을 수행할 수는 있지만 풀 수는 없다.

2) Shrinking Phase (수축단계) : Lock을 수행할 수는 없지만 풀 수는 있다. 
...
Take a moment to analyze the schedule. 
Yes, you’re correct, because of Dirty Read in T2 and T3 in lines 8 and 12 respectively, 
when T1 failed we have to roll back others also. 

Hence, Cascading Rollbacks are possible in 2-PL. 
I have taken skeleton schedules as examples 
because it’s easy to understand when it’s kept simple. 
...
GATE CS 2016-2 | Question 61
GATE CS 1999 | Question 31
